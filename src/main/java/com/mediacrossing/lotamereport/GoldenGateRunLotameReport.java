...
import com.mediacrossing.sources.appnexus.JPutneyConnectivity;
import com.mediacrossing.sources.appnexus.reads.buy.JConfiguredBuyReadRequest;
import com.mediacrossing.sources.appnexus.reads.buy.ProfileRequest;
...
public class GoldenGateRunLotameReport {

    private static final Logger LOG = LoggerFactory.getLogger(GoldenGateRunLotameReport.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Can now do:
        final JPutneyConnectivity pc = new JPutneyConnectivity(properties);
        final JConfiguredBuyReadRequest brr = new JConfiguredBuyReadRequest();
        final ExecutionContext ec =
                ExecutionContext.Implicits$.MODULE$.global();

        brr.profiles(
                new ProfileRequest("profileId", "advId"),
                pc.putneyClient(),
                ec,
                pc.readRequestTimeout());
        // Parse results into desired object
